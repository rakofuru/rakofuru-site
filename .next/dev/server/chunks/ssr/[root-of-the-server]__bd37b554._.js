...
const getFarmBySlug = (slug)=>{
    return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["farms"].find((farm)=>farm.slug === slug);
};
const getCommentsForFarm = (farmSlug)=>{
    const farmComments = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["legacyComments"].filter((comment)=>comment.farmSlug === farmSlug);
...
const buildFarmCanonicalUrl = (farm)=>{
    ...
    return `${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["site"].canonicalDomain}/farms/${farm.slug}`;
};
const pickFarmOgImage = (farm)=>{
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["site"].seo.ogImageUrl;
};
const generateStaticParams = ()=>{
    return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["farms"].map((farm)=>({
            slug: farm.slug
        }));
};
const generateMetadata = async ({ params })=>{
    ...
    const description = farm.excerpt ?? __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["site"].seo.defaultDescription;
...
async function FarmDetailPage({ params }) {
    const { slug } = await params;
    const farm = getFarmBySlug(slug);
    if (!farm) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bd37b554._.js.map